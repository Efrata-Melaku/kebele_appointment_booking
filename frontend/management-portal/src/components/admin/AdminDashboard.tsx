  ...
  const quickActions = [
    {
      ...
      icon: UserPlus,
      color: 'bg-blue-500',
      onClick: () => navigate(managementRoutes.admin.staff),
    },
    {
      label: 'Bulk slot sync',
      icon: Calendar,
      color: 'bg-green-500',
      onClick: () => navigate(managementRoutes.admin.limits),
    },
    {
      label: 'Schedule overrides',
      icon: Settings,
      color: 'bg-teal-600',
      onClick: () => navigate(managementRoutes.admin.schedule),
    },
    {
      label: 'Manage services',
      icon: FileText,
      color: 'bg-purple-500',
      onClick: () => navigate(managementRoutes.admin.services),
    },
  ];
